 ...
 */
  ...
  __pyx_t_9 = 0;
  __pyx_t_9 = PyObject_GetItem(((PyObject *)__pyx_v_X), __pyx_t_10); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 */
  __pyx_t_4 = __pyx_v_r;
  for (__pyx_t_15 = 1; __pyx_t_15 < __pyx_t_4; __pyx_t_15+=1) {
 ...
 */
    ...
    for (__pyx_t_19 = __pyx_v_jstart; __pyx_t_19 < __pyx_t_16; __pyx_t_19+=1) {
 ...
 */
      ...
      } else if (unlikely(__pyx_t_29 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_22 = 0;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_pybuffernd_D.diminfo[1].shape;
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_22 = 1;
      } else if (unlikely(__pyx_t_30 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_22 = 1;
      if (unlikely(__pyx_t_22 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_22);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      *__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_30, __pyx_pybuffernd_D.diminfo[1].strides) = ((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_21, __pyx_pybuffernd_D.diminfo[1].strides)) + __pyx_f_3dtw_min_c(__pyx_f_3dtw_min_c((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_D.diminfo[1].strides)), (*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_D.diminfo[1].strides))), (*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_28, __pyx_pybuffernd_D.diminfo[1].strides))));
    }
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_31 = __pyx_v_lx;
  __pyx_t_32 = __pyx_v_ly;
  __pyx_t_4 = -1;
  if (__pyx_t_31 < 0) {
    __pyx_t_31 += __pyx_pybuffernd_D.diminfo[0].shape;
    if (unlikely(__pyx_t_31 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_31 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_4 = 0;
  if (__pyx_t_32 < 0) {
    __pyx_t_32 += __pyx_pybuffernd_D.diminfo[1].shape;
    if (unlikely(__pyx_t_32 < 0)) __pyx_t_4 = 1;
  } else if (unlikely(__pyx_t_32 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_4 = 1;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 65, __pyx_L1_error)
  }
  __pyx_t_12 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_D.diminfo[1].strides))); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_8 = NULL;
